...
//		VectorCopy( ent->r.mins, ent->player->history[i].mins );
//		VectorCopy( ent->r.maxs, ent->player->history[i].maxs );
		VectorCopy( ent->player->ps.mins, ent->player->history[i].mins );
		VectorCopy( ent->player->ps.maxs, ent->player->history[i].maxs );
...
//	VectorCopy( ent->r.mins, ent->player->history[head].mins );
//	VectorCopy( ent->r.maxs, ent->player->history[head].maxs );
	VectorCopy( ent->player->ps.mins, ent->player->history[head].mins );
	VectorCopy( ent->player->ps.maxs, ent->player->history[head].maxs );
...
//			VectorCopy( ent->r.mins, ent->player->saved.mins );
//			VectorCopy( ent->r.maxs, ent->player->saved.maxs );
			VectorCopy( ent->player->ps.mins, ent->player->saved.mins );
			VectorCopy( ent->player->ps.maxs, ent->player->saved.maxs );
...
//			VectorCopy( ent->player->history[k].mins, ent->r.mins );
//			VectorCopy( ent->player->history[k].maxs, ent->r.maxs );
			VectorCopy( ent->player->history[k].mins, ent->player->ps.mins );
			VectorCopy( ent->player->history[k].maxs, ent->player->ps.maxs );
...
void G_UnTimeShiftClient( gentity_t *ent ) {
	...
	if ( ent->player->saved.leveltime == level.time ) {
		// move it back
		//VectorCopy( ent->player->saved.mins, ent->r.mins );
		//VectorCopy( ent->player->saved.maxs, ent->r.maxs );
		VectorCopy( ent->player->saved.mins, ent->player->ps.mins );
		VectorCopy( ent->player->saved.maxs, ent->player->ps.maxs );
...
//		trap_Trace( &trace, origin, ent->r.mins, ent->r.maxs, end, ent->s.number, ent->clipmask );
		trap_Trace( &trace, origin, ent->player->ps.mins, ent->player->ps.maxs, end, ent->s.number, ent->clipmask );
...
void G_PredictPlayerStepSlideMove( gentity_t *ent, float frametime ) {
	...
	trap_Trace( &trace, start_o, ent->player->ps.mins, ent->player->ps.maxs, up, ent->s.number, ent->clipmask );
	if ( trace.allsolid ) {
	...
	trap_Trace( &trace, ent->s.pos.trBase, ent->player->ps.mins, ent->player->ps.maxs, down, ent->s.number, ent->clipmask );
	if ( !trace.allsolid ) {
		VectorCopy( trace.endpos, ent->s.pos.trBase );
	}
